...
<main style={{ position: 'relative', zIndex: '1', maxWidth: '480px', margin: '0 auto', padding: '28px 16px 80px', display: 'flex', flexDirection: 'column', gap: '48px' }}>
  ...
  <section className="flow-state" id="state-intro" data-screen-label="1 · Kirish">
    ...
    <div className="survey-intro" style={{ background: 'var(--glass)', backdropFilter: 'blur(20px)', WebkitBackdropFilter: 'blur(20px)', border: '1px solid var(--glass-border)', borderRadius: 'var(--radius-lg)', boxShadow: 'var(--shadow-glass),var(--glass-inner)', padding: '24px 20px' }}>
      ...
      <button type="button" id="btn-flow-start" className="btn btn-primary" style={{ fontFamily: 'var(--font-body)', fontWeight: '600', fontSize: 'var(--text-md)', padding: '14px 20px', borderRadius: 'var(--radius-md)', border: '1px solid rgba(255,255,255,.6)', background: 'linear-gradient(180deg,var(--mint-500),var(--mint-600))', color: '#fff', cursor: 'pointer', width: '100%', minHeight: '48px', boxShadow: 'var(--glow-mint),inset 0 1px 0 rgba(255,255,255,.35)', transition: 'filter .12s' }} style-hover="filter:brightness(1.08)">Boshlash</button>
    </div>
  </section>
      ...
      <div style={{ padding: '20px' }}>
        ...
        <fieldset className="quiz-options" style={{ border: '0', padding: '0', margin: '0 0 24px' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '10px' }}>
            <label className="quiz-option" data-option="q4-a" style={{ display: 'flex', alignItems: 'center', gap: '12px', padding: '14px 16px', borderRadius: 'var(--radius-md)', border: '1px solid var(--line)', background: 'rgba(255,255,255,.35)', cursor: 'pointer', fontSize: 'var(--text-base)', minHeight: '48px', boxSizing: 'border-box' }} style-hover="background:var(--glass)"><input type="radio" name="flow-q4" id="flow-q4-a" style={{ width: '18px', height: '18px', accentColor: 'var(--mint-600)', margin: '0', flex: 'none' }} />Darhol o'tkazib yuboraman</label>
            ...
            <label className="quiz-option" data-option="q4-c" style={{ display: 'flex', alignItems: 'center', gap: '12px', padding: '14px 16px', borderRadius: 'var(--radius-md)', border: '1px solid var(--line)', background: 'rgba(255,255,255,.35)', cursor: 'pointer', fontSize: 'var(--text-base)', minHeight: '48px', boxSizing: 'border-box' }} style-hover="background:var(--glass)"><input type="radio" name="flow-q4" id="flow-q4-c" style={{ width: '18px', height: '18px', accentColor: 'var(--mint-600)', margin: '0', flex: 'none' }} />Havolani bosib mahsulotni ko'raman</label>
            <label className="quiz-option" data-option="q4-d" style={{ display: 'flex', alignItems: 'center', gap: '12px', padding: '14px 16px', borderRadius: 'var(--radius-md)', border: '1px solid var(--line)', background: 'rgba(255,255,255,.35)', cursor: 'pointer', fontSize: 'var(--text-base)', minHeight: '48px', boxSizing: 'border-box' }} style-hover="background:var(--glass)"><input type="radio" name="flow-q4" id="flow-q4-d" style={{ width: '18px', height: '18px', accentColor: 'var(--mint-600)', margin: '0', flex: 'none' }} />Reklama beruvchini bloklayman</label>
            <label className="quiz-option" data-option="q4-e" style={{ display: 'flex', alignItems: 'center', gap: '12px', padding: '14px 16px', borderRadius: 'var(--radius-md)', border: '1px solid var(--line)', background: 'rgba(255,255,255,.35)', cursor: 'pointer', fontSize: 'var(--text-base)', minHeight: '48px', boxSizing: 'border-box' }} style-hover="background:var(--glass)"><input type="radio" name="flow-q4" id="flow-q4-e" style={{ width: '18px', height: '18px', accentColor: 'var(--mint-600)', margin: '0', flex: 'none' }} />Reklamani deyarli sezmayman</label>
          </div>
        </fieldset>
        <div className="quiz-actions" style={{ display: 'flex', justifyContent: 'space-between', gap: '12px' }}>
          <button type="button" id="btn-flow-back" className="btn btn-ghost" style={{ fontFamily: 'var(--font-body)', fontWeight: '600', fontSize: 'var(--text-base)', padding: '12px 20px', borderRadius: 'var(--radius-md)', border: '1px solid transparent', background: 'transparent', color: 'var(--ink-mid)', cursor: 'pointer', minHeight: '48px', transition: 'background .12s' }} style-hover="background:var(--glass);color:var(--ink)">Orqaga</button>
          <button type="button" id="btn-flow-next" className="btn btn-primary" style={{ fontFamily: 'var(--font-body)', fontWeight: '600', fontSize: 'var(--text-base)', padding: '12px 28px', borderRadius: 'var(--radius-md)', border: '1px solid rgba(255,255,255,.6)', background: 'linear-gradient(180deg,var(--mint-500),var(--mint-600))', color: '#fff', cursor: 'pointer', minHeight: '48px', boxShadow: 'var(--glow-mint),inset 0 1px 0 rgba(255,255,255,.35)', transition: 'filter .12s' }} style-hover="filter:brightness(1.08)">Keyingi</button>
        </div>
      </div>
    </div>
  </section>
  ...
  <section className="flow-state" id="state-complete" data-screen-label="3 · Yakunlandi">
    ...
    <div className="survey-complete" style={{ position: 'relative', overflow: 'hidden', background: 'linear-gradient(160deg,rgba(24,133,99,.16),rgba(255,255,255,.6) 60%)', backdropFilter: 'blur(20px)', WebkitBackdropFilter: 'blur(20px)', border: '1px solid var(--mint-glass-border)', borderRadius: 'var(--radius-lg)', boxShadow: 'var(--shadow-glass),var(--glass-inner)', padding: '32px 20px', textAlign: 'center' }}>
      ...
      <div style={{ position: 'relative', display: 'flex', flexDirection: 'column', gap: '10px' }}>
        <button type="button" id="btn-find-another" className="btn btn-primary" style={{ fontFamily: 'var(--font-body)', fontWeight: '600', fontSize: 'var(--text-md)', padding: '14px 20px', borderRadius: 'var(--radius-md)', border: '1px solid rgba(255,255,255,.6)', background: 'linear-gradient(180deg,var(--mint-500),var(--mint-600))', color: '#fff', cursor: 'pointer', width: '100%', minHeight: '48px', boxShadow: 'var(--glow-mint),inset 0 1px 0 rgba(255,255,255,.35)', transition: 'filter .12s' }} style-hover="filter:brightness(1.08)">Boshqa so'rovnoma topish</button>
        <a href="taker-dashboard.dc.html" id="btn-go-home" className="btn btn-secondary" style={{ fontFamily: 'var(--font-body)', fontWeight: '600', fontSize: 'var(--text-md)', padding: '14px 20px', borderRadius: 'var(--radius-md)', border: '1px solid var(--glass-border)', background: 'var(--glass)', color: 'var(--ink)', cursor: 'pointer', width: '100%', minHeight: '48px', boxSizing: 'border-box', display: 'inline-flex', alignItems: 'center', justifyContent: 'center', boxShadow: 'var(--shadow-sm),var(--glass-inner)', transition: 'background .12s' }} style-hover="background:var(--glass-strong)">Bosh sahifaga</a>
      </div>
    </div>
  </section>

  
  <section className="flow-state" id="state-flagged" data-screen-label="4 · Tekshiruvda">
    <p className="state-label" style={{ margin: '0 0 10px', fontFamily: 'var(--font-mono)', fontSize: 'var(--text-xs)', letterSpacing: '.06em', color: 'var(--ink-soft)' }}>4 · TEKSHIRUVDA</p>
    <div className="survey-flagged" style={{ position: 'relative', overflow: 'hidden', background: 'linear-gradient(160deg,rgba(168,115,28,.16),rgba(255,255,255,.6) 60%)', backdropFilter: 'blur(20px)', WebkitBackdropFilter: 'blur(20px)', border: '1px solid var(--amber-glass-border)', borderRadius: 'var(--radius-lg)', boxShadow: 'var(--shadow-glass),var(--glass-inner)', padding: '32px 20px', textAlign: 'center' }}>
      <div aria-hidden="true" style={{ position: 'absolute', width: '260px', height: '260px', borderRadius: '50%', background: 'radial-gradient(circle,rgba(168,115,28,.3),transparent 70%)', top: '-110px', left: '50%', transform: 'translateX(-50%)', filter: 'blur(16px)' }}></div>
      <span className="warning-icon" style={{ position: 'relative', display: 'inline-flex', width: '64px', height: '64px', borderRadius: '50%', background: 'linear-gradient(180deg,#C98F2E,var(--amber))', border: '1px solid rgba(255,255,255,.5)', boxShadow: '0 6px 16px rgba(168,115,28,.35),inset 0 1px 0 rgba(255,255,255,.3)', alignItems: 'center', justifyContent: 'center', marginBottom: '16px' }}>
        <svg width={28} height={28} viewBox="0 0 24 24" fill="none" stroke="#fff" strokeWidth="2.2" strokeLinecap="round" aria-hidden="true"><circle cx="12" cy="12" r="9"></circle><path d="M12 7.5v5.5M12 16.5v.5"></path></svg>
      </span>
      <h2 style={{ position: 'relative', fontFamily: 'var(--font-display)', fontSize: 'var(--text-lg)', fontWeight: '700', margin: '0 0 14px' }}>Javobingiz tekshiruvga yuborildi.</h2>
      <p className="reward-amount is-held" style={{ position: 'relative', margin: '0 0 6px', fontFamily: 'var(--font-display)', fontSize: 'var(--text-3xl)', fontWeight: '800', letterSpacing: '-.02em', color: 'var(--amber)', fontVariantNumeric: 'tabular-nums' }}>3 000 so'm</p>
      <p style={{ position: 'relative', margin: '0 0 18px', fontSize: 'var(--text-sm)', color: 'var(--ink-mid)' }}>Ba'zi javoblar juda tez berilgan. Tekshiruv odatda 2 ish kunida yakunlanadi — natija haqida xabar beramiz.</p>
      <div className="pending-balance" style={{ position: 'relative', display: 'inline-flex', alignItems: 'baseline', gap: '8px', padding: '10px 18px', borderRadius: 'var(--radius-pill)', background: 'rgba(255,255,255,.6)', border: '1px solid var(--glass-border)', boxShadow: 'var(--shadow-sm)', marginBottom: '24px' }}>
        <span style={{ fontSize: 'var(--text-xs)', fontWeight: '600', color: 'var(--ink-mid)', letterSpacing: '.03em' }}>TEKSHIRUVDA</span>
        <span style={{ fontFamily: 'var(--font-display)', fontSize: 'var(--text-md)', fontWeight: '700', color: 'var(--amber)', fontVariantNumeric: 'tabular-nums' }}>3 000 so'm</span>
      </div>
      <div style={{ position: 'relative', display: 'flex', flexDirection: 'column', gap: '10px' }}>
        <button type="button" id="btn-find-another-flagged" className="btn btn-primary" style={{ fontFamily: 'var(--font-body)', fontWeight: '600', fontSize: 'var(--text-md)', padding: '14px 20px', borderRadius: 'var(--radius-md)', border: '1px solid rgba(255,255,255,.6)', background: 'linear-gradient(180deg,var(--mint-500),var(--mint-600))', color: '#fff', cursor: 'pointer', width: '100%', minHeight: '48px', boxShadow: 'var(--glow-mint),inset 0 1px 0 rgba(255,255,255,.35)', transition: 'filter .12s' }} style-hover="filter:brightness(1.08)">Boshqa so'rovnoma topish</button>
        <a href="taker-dashboard.dc.html" id="btn-go-home-flagged" className="btn btn-secondary" style={{ fontFamily: 'var(--font-body)', fontWeight: '600', fontSize: 'var(--text-md)', padding: '14px 20px', borderRadius: 'var(--radius-md)', border: '1px solid var(--glass-border)', background: 'var(--glass)', color: 'var(--ink)', cursor: 'pointer', width: '100%', minHeight: '48px', boxSizing: 'border-box', display: 'inline-flex', alignItems: 'center', justifyContent: 'center', boxShadow: 'var(--shadow-sm),var(--glass-inner)', transition: 'background .12s' }} style-hover="background:var(--glass-strong)">Bosh sahifaga</a>
      </div>
    </div>
  </section>
</main>
