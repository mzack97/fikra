...
<main style={{ position: 'relative', zIndex: '1', maxWidth: '1140px', margin: '0 auto', padding: '48px 32px 96px', display: 'flex', flexDirection: 'column', gap: '64px' }}>
  ...
  <section className="ds-section" id="buttons">
    ...
    <div className="button-matrix" style={{ background: 'var(--glass)', backdropFilter: 'blur(20px)', WebkitBackdropFilter: 'blur(20px)', border: '1px solid var(--glass-border)', borderRadius: 'var(--radius-lg)', boxShadow: 'var(--shadow-glass),var(--glass-inner)', padding: '28px 32px', display: 'grid', gridTemplateColumns: '110px repeat(4,auto)', gap: '18px 28px', alignItems: 'center', justifyContent: 'start', overflowX: 'auto' }}>
      ...
      <button type="button" id="btn-primary" className="btn btn-primary hv-2" style={{ fontFamily: 'var(--font-body)', fontWeight: '600', fontSize: 'var(--text-base)', padding: '10px 20px', borderRadius: 'var(--radius-md)', border: '1px solid rgba(255,255,255,.6)', background: 'linear-gradient(180deg,var(--mint-500),var(--mint-600))', color: '#fff', cursor: 'pointer', boxShadow: 'var(--glow-mint),inset 0 1px 0 rgba(255,255,255,.35)', transition: 'filter .12s' }}>So'rovnoma yaratish</button>
      ...
      <button type="button" id="btn-secondary" className="btn btn-secondary hv-1" style={{ fontFamily: 'var(--font-body)', fontWeight: '600', fontSize: 'var(--text-base)', padding: '10px 20px', borderRadius: 'var(--radius-md)', border: '1px solid var(--glass-border)', background: 'var(--glass)', backdropFilter: 'blur(12px)', WebkitBackdropFilter: 'blur(12px)', color: 'var(--ink)', cursor: 'pointer', boxShadow: 'var(--shadow-sm),var(--glass-inner)', transition: 'background .12s' }}>Qoralama saqlash</button>
      ...
      <button type="button" id="btn-ghost" className="btn btn-ghost hv-10" style={{ fontFamily: 'var(--font-body)', fontWeight: '600', fontSize: 'var(--text-base)', padding: '10px 20px', borderRadius: 'var(--radius-md)', border: '1px solid transparent', background: 'transparent', color: 'var(--ink-mid)', cursor: 'pointer', transition: 'background .12s,color .12s' }}>Bekor qilish</button>
      ...
      <button type="button" id="btn-danger" className="btn btn-danger hv-2" style={{ fontFamily: 'var(--font-body)', fontWeight: '600', fontSize: 'var(--text-base)', padding: '10px 20px', borderRadius: 'var(--radius-md)', border: '1px solid rgba(255,255,255,.55)', background: 'linear-gradient(180deg,var(--danger),var(--danger-deep))', color: '#fff', cursor: 'pointer', boxShadow: '0 6px 16px rgba(204,66,87,.3),inset 0 1px 0 rgba(255,255,255,.3)', transition: 'filter .12s' }}>So'rovnomani o'chirish</button>
    ...
    <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit,minmax(320px,1fr))', gap: '20px', alignItems: 'start' }}>
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
        ...
        <div className="empty-state card" style={{ background: 'var(--glass-soft)', backdropFilter: 'blur(14px)', WebkitBackdropFilter: 'blur(14px)', border: '1px dashed var(--line-strong)', borderRadius: 'var(--radius-lg)', padding: '36px 24px', display: 'flex', flexDirection: 'column', alignItems: 'center', textAlign: 'center', gap: '6px' }}>
          ...
          <button type="button" className="btn btn-primary hv-2" data-action="empty-create" style={{ fontFamily: 'var(--font-body)', fontWeight: '600', fontSize: 'var(--text-base)', padding: '10px 20px', borderRadius: 'var(--radius-md)', border: '1px solid rgba(255,255,255,.6)', background: 'linear-gradient(180deg,var(--mint-500),var(--mint-600))', color: '#fff', cursor: 'pointer', boxShadow: 'var(--glow-mint),inset 0 1px 0 rgba(255,255,255,.35)' }}>So'rovnoma yaratish</button>
        </div>
        ...
        <div className="modal-demo" style={{ position: 'relative', border: '1px solid var(--glass-border)', borderRadius: 'var(--radius-lg)', padding: '32px', display: 'flex', justifyContent: 'center', overflow: 'hidden', background: 'linear-gradient(140deg,var(--bg-a),var(--bg-b))' }}>
          ...
          <div className="modal" role="dialog" aria-labelledby="modal-title" style={{ position: 'relative', background: 'var(--glass-strong)', backdropFilter: 'blur(24px)', WebkitBackdropFilter: 'blur(24px)', border: '1px solid var(--glass-border)', borderRadius: 'var(--radius-lg)', boxShadow: 'var(--shadow-float),var(--glass-inner)', maxWidth: '380px', width: '100%', padding: '24px' }}>
            ...
            <div className="modal-actions" style={{ display: 'flex', justifyContent: 'flex-end', gap: '10px' }}>
              <button type="button" className="btn btn-ghost hv-15" data-action="modal-cancel" style={{ fontFamily: 'var(--font-body)', fontWeight: '600', fontSize: 'var(--text-base)', padding: '10px 18px', borderRadius: 'var(--radius-md)', border: '1px solid transparent', background: 'transparent', color: 'var(--ink-mid)', cursor: 'pointer' }}>Bekor qilish</button>
              <button type="button" className="btn btn-secondary hv-1" data-action="modal-confirm" style={{ fontFamily: 'var(--font-body)', fontWeight: '600', fontSize: 'var(--text-base)', padding: '10px 18px', borderRadius: 'var(--radius-md)', border: '1px solid var(--glass-border)', background: 'var(--glass)', color: 'var(--ink)', cursor: 'pointer', boxShadow: 'var(--shadow-sm),var(--glass-inner)' }}>To'xtatish</button>
            </div>
          </div>
        </div>
      </div>
  ...
  <section className="ds-section" id="composed-taker">
    ...
    <div className="survey-card" data-survey="s-204" style={{ background: 'var(--glass)', backdropFilter: 'blur(20px)', WebkitBackdropFilter: 'blur(20px)', border: '1px solid var(--glass-border)', borderRadius: 'var(--radius-lg)', boxShadow: 'var(--shadow-glass),var(--glass-inner)', padding: '20px', maxWidth: '400px', display: 'flex', flexDirection: 'column', gap: '14px' }}>
      ...
      <button type="button" className="btn btn-primary btn-block hv-2" data-action="survey-start" style={{ fontFamily: 'var(--font-body)', fontWeight: '600', fontSize: 'var(--text-md)', padding: '13px 20px', borderRadius: 'var(--radius-md)', border: '1px solid rgba(255,255,255,.6)', background: 'linear-gradient(180deg,var(--mint-500),var(--mint-600))', color: '#fff', cursor: 'pointer', width: '100%', boxShadow: 'var(--glow-mint),inset 0 1px 0 rgba(255,255,255,.35)' }}>Boshlash</button>
    </div>
  </section>
