...
<div className="app-shell">
  <aside className="app-sidebar" style={{ flexDirection: 'column', gap: '8px', background: 'rgba(255,255,255,.5)', backdropFilter: 'blur(20px)', WebkitBackdropFilter: 'blur(20px)', borderRight: '1px solid var(--glass-border)', padding: '24px 16px', position: 'sticky', top: '0', height: '100vh', boxSizing: 'border-box' }}>
    ...
    <nav className="side-nav" aria-label="Asosiy" style={{ display: 'flex', flexDirection: 'column', gap: '4px', flex: '1' }}>
      <a href="#" id="side-home" className="side-link is-active" aria-current="page" style={{ display: 'flex', alignItems: 'center', gap: '12px', padding: '11px 12px', borderRadius: 'var(--radius-md)', fontSize: 'var(--text-sm)', fontWeight: '600', color: 'var(--mint-700)', background: 'var(--mint-glass)', border: '1px solid var(--mint-glass-border)' }}>
        ...
        Bosh sahifa</a>
      <a href="#" id="side-surveys" className="side-link hv-10" style={{ display: 'flex', alignItems: 'center', gap: '12px', padding: '11px 12px', borderRadius: 'var(--radius-md)', fontSize: 'var(--text-sm)', fontWeight: '500', color: 'var(--ink-mid)', border: '1px solid transparent' }}>
        ...
        So'rovnomalarim</a>
      <a href="#" id="side-panel" className="side-link hv-10" style={{ display: 'flex', alignItems: 'center', gap: '12px', padding: '11px 12px', borderRadius: 'var(--radius-md)', fontSize: 'var(--text-sm)', fontWeight: '500', color: 'var(--ink-mid)', border: '1px solid transparent' }}>
        ...
        Auditoriya paneli</a>
      <a href="#" id="side-billing" className="side-link hv-10" style={{ display: 'flex', alignItems: 'center', gap: '12px', padding: '11px 12px', borderRadius: 'var(--radius-md)', fontSize: 'var(--text-sm)', fontWeight: '500', color: 'var(--ink-mid)', border: '1px solid transparent' }}>
  ...
  <main className="app-content" style={{ padding: '32px 32px 64px', minWidth: '0', boxSizing: 'border-box' }}>
    <div className="page-head" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', gap: '16px', flexWrap: 'wrap', marginBottom: '20px' }}>
      ...
      <button type="button" id="btn-create-survey" className="btn btn-primary hv-2" style={{ fontFamily: 'var(--font-body)', fontWeight: '600', fontSize: 'var(--text-base)', padding: '11px 22px', borderRadius: 'var(--radius-md)', border: '1px solid rgba(255,255,255,.6)', background: 'linear-gradient(180deg,var(--mint-500),var(--mint-600))', color: '#fff', cursor: 'pointer', display: 'inline-flex', alignItems: 'center', gap: '8px', boxShadow: 'var(--glow-mint),inset 0 1px 0 rgba(255,255,255,.35)', transition: 'filter .12s' }}>
            ...
            {/* SC-FOR: sc-for */}
              <tr className="table-row" data-row="[row.id]" style={{ borderBottom: '1px solid var(--line)' }}>
                ...
                <td style={{ padding: '12px 16px', textAlign: 'right', position: 'relative' }}>
                  <button type="button" className="row-menu-btn hv-3" data-action="[row.menuAction]" aria-label="Amallar menyusi" aria-haspopup="menu" style={{ background: 'none', border: '1px solid transparent', borderRadius: 'var(--radius-sm)', padding: '6px', cursor: 'pointer', color: 'var(--ink-mid)', lineHeight: '0' }}>
                  ...
                  {/* SC-IF: sc-if */}
                    <div className="row-menu" role="menu" style={{ position: 'absolute', right: '12px', top: '44px', zIndex: '5', background: 'var(--glass-strong)', backdropFilter: 'blur(24px)', WebkitBackdropFilter: 'blur(24px)', border: '1px solid var(--glass-border)', borderRadius: 'var(--radius-md)', boxShadow: 'var(--shadow-float)', padding: '6px', display: 'flex', flexDirection: 'column', minWidth: '170px' }}>
                      <button type="button" role="menuitem" data-action="menu-view" style={{ fontFamily: 'var(--font-body)', fontSize: 'var(--text-sm)', textAlign: 'left', background: 'none', border: '0', borderRadius: 'var(--radius-sm)', padding: '9px 12px', cursor: 'pointer', color: 'var(--ink)' }} className="hv-6">Natijalarni ko'rish</button>
                      <button type="button" role="menuitem" data-action="menu-duplicate" style={{ fontFamily: 'var(--font-body)', fontSize: 'var(--text-sm)', textAlign: 'left', background: 'none', border: '0', borderRadius: 'var(--radius-sm)', padding: '9px 12px', cursor: 'pointer', color: 'var(--ink)' }} className="hv-6">Nusxa olish</button>
                      <button type="button" role="menuitem" data-action="menu-pause" style={{ fontFamily: 'var(--font-body)', fontSize: 'var(--text-sm)', textAlign: 'left', background: 'none', border: '0', borderRadius: 'var(--radius-sm)', padding: '9px 12px', cursor: 'pointer', color: 'var(--ink)' }} className="hv-6">Pauza qilish</button>
                      <button type="button" role="menuitem" data-action="menu-delete" style={{ fontFamily: 'var(--font-body)', fontSize: 'var(--text-sm)', textAlign: 'left', background: 'none', border: '0', borderRadius: 'var(--radius-sm)', padding: '9px 12px', cursor: 'pointer', color: 'var(--danger)' }} className="hv-8">O'chirish</button>
                    </div>
