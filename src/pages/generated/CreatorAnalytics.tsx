...
<div className="app-shell">
  <aside className="app-sidebar" style={{ flexDirection: 'column', gap: '8px', background: 'rgba(255,255,255,.5)', backdropFilter: 'blur(20px)', WebkitBackdropFilter: 'blur(20px)', borderRight: '1px solid var(--glass-border)', padding: '24px 16px', position: 'sticky', top: '0', height: '100vh', boxSizing: 'border-box' }}>
    ...
    <nav className="side-nav" aria-label="Asosiy" style={{ display: 'flex', flexDirection: 'column', gap: '4px', flex: '1' }}>
      <a href="creator-dashboard.dc.html" id="side-home" className="side-link hv-10" style={{ display: 'flex', alignItems: 'center', gap: '12px', padding: '11px 12px', borderRadius: 'var(--radius-md)', fontSize: 'var(--text-sm)', fontWeight: '500', color: 'var(--ink-mid)', border: '1px solid transparent' }}>
  ...
  <main className="app-content" style={{ padding: '32px 32px 64px', minWidth: '0', boxSizing: 'border-box' }}>
    ...
    <div className="analytics-head" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', gap: '16px', flexWrap: 'wrap', marginBottom: '20px' }}>
      ...
      <div className="analytics-actions" style={{ display: 'flex', gap: '8px', flexWrap: 'wrap' }}>
        <button type="button" id="btn-export-csv" className="btn btn-secondary hv-1" style={{ fontFamily: 'var(--font-body)', fontWeight: '600', fontSize: 'var(--text-sm)', padding: '9px 15px', borderRadius: 'var(--radius-md)', border: '1px solid var(--glass-border)', background: 'var(--glass)', color: 'var(--ink)', cursor: 'pointer', display: 'inline-flex', alignItems: 'center', gap: '7px', boxShadow: 'var(--shadow-sm),var(--glass-inner)', transition: 'background .12s' }}>
        ...
        <button type="button" id="btn-export-json" className="btn btn-secondary hv-1" style={{ fontFamily: 'var(--font-body)', fontWeight: '600', fontSize: 'var(--text-sm)', padding: '9px 15px', borderRadius: 'var(--radius-md)', border: '1px solid var(--glass-border)', background: 'var(--glass)', color: 'var(--ink)', cursor: 'pointer', boxShadow: 'var(--shadow-sm),var(--glass-inner)', transition: 'background .12s' }}>JSON</button>
        <button type="button" id="btn-pause-survey" className="btn btn-secondary hv-9" style={{ fontFamily: 'var(--font-body)', fontWeight: '600', fontSize: 'var(--text-sm)', padding: '9px 15px', borderRadius: 'var(--radius-md)', border: '1px solid var(--amber-glass-border)', background: 'var(--amber-glass)', color: 'var(--amber)', cursor: 'pointer', display: 'inline-flex', alignItems: 'center', gap: '7px', transition: 'filter .12s' }}>
          ...
          To'xtatish</button>
        <button type="button" id="btn-finish-survey" className="btn btn-primary hv-2" style={{ fontFamily: 'var(--font-body)', fontWeight: '600', fontSize: 'var(--text-sm)', padding: '9px 17px', borderRadius: 'var(--radius-md)', border: '1px solid rgba(255,255,255,.6)', background: 'linear-gradient(180deg,var(--mint-500),var(--mint-600))', color: '#fff', cursor: 'pointer', boxShadow: 'var(--glow-mint),inset 0 1px 0 rgba(255,255,255,.35)', transition: 'filter .12s' }}>Yakunlash</button>
      </div>
    </div>
