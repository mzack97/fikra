...
<main style={{ position: 'relative', zIndex: '1', maxWidth: '480px', margin: '0 auto', padding: '48px 16px 96px', display: 'flex', flexDirection: 'column', alignItems: 'stretch' }}>
  ...
  <section className="reg-step" id="step-phone" data-screen-label="1 · Telefon" style={{ background: 'var(--glass)', backdropFilter: 'blur(20px)', WebkitBackdropFilter: 'blur(20px)', border: '1px solid var(--glass-border)', borderRadius: 'var(--radius-lg)', boxShadow: 'var(--shadow-glass),var(--glass-inner)', padding: '28px 24px' }}>
    ...
    <button type="button" id="btn-send-code" className="btn btn-primary" style={{ fontFamily: 'var(--font-body)', fontWeight: '600', fontSize: 'var(--text-md)', padding: '13px 20px', borderRadius: 'var(--radius-md)', border: '1px solid rgba(255,255,255,.6)', background: 'linear-gradient(180deg,var(--mint-500),var(--mint-600))', color: '#fff', cursor: 'pointer', width: '100%', boxShadow: 'var(--glow-mint),inset 0 1px 0 rgba(255,255,255,.35)', transition: 'filter .12s' }} style-hover="filter:brightness(1.08)">Kod yuborish</button>
  </section>
  ...
  <section className="reg-step" id="step-identity" data-screen-label="3 · Shaxs" style={{ background: 'var(--glass)', backdropFilter: 'blur(20px)', WebkitBackdropFilter: 'blur(20px)', border: '1px solid var(--glass-border)', borderRadius: 'var(--radius-lg)', boxShadow: 'var(--shadow-glass),var(--glass-inner)', padding: '28px 24px' }}>
    ...
    <button type="button" id="btn-oneid" className="btn btn-oneid" style={{ fontFamily: 'var(--font-body)', fontWeight: '600', fontSize: 'var(--text-md)', padding: '13px 20px', borderRadius: 'var(--radius-md)', border: '1px solid rgba(255,255,255,.35)', background: 'linear-gradient(180deg,#2A363C,var(--ink))', color: '#fff', cursor: 'pointer', width: '100%', display: 'inline-flex', alignItems: 'center', justifyContent: 'center', gap: '10px', boxShadow: '0 6px 16px rgba(27,34,38,.3),inset 0 1px 0 rgba(255,255,255,.18)', transition: 'filter .12s' }} style-hover="filter:brightness(1.15)">
    ...
    <p style={{ margin: '14px 0 0', textAlign: 'center' }}><a href="#step-basics" id="link-skip-identity" style={{ fontSize: 'var(--text-sm)', color: 'var(--ink-mid)', textDecoration: 'underline' }} style-hover="color:var(--ink)">Hozircha o'tkazib yuborish</a></p>
  </section>
  ...
  <section className="reg-step" id="step-quiz" data-screen-label="5 · Viktorina" style={{ background: 'var(--glass)', backdropFilter: 'blur(20px)', WebkitBackdropFilter: 'blur(20px)', border: '1px solid var(--glass-border)', borderRadius: 'var(--radius-lg)', boxShadow: 'var(--shadow-glass),var(--glass-inner)', padding: '28px 24px' }}>
    ...
    <fieldset className="quiz-options" style={{ border: '0', padding: '0', margin: '0 0 24px' }}>
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: '10px' }}>
        <label className="quiz-option" data-option="q3-a" style={{ display: 'flex', alignItems: 'center', gap: '12px', padding: '14px 16px', borderRadius: 'var(--radius-md)', border: '1px solid var(--line)', background: 'rgba(255,255,255,.35)', cursor: 'pointer', fontSize: 'var(--text-base)', minHeight: '44px', boxSizing: 'border-box' }} style-hover="background:var(--glass)"><input type="radio" name="quiz-q3" id="quiz-q3-a" style={{ width: '18px', height: '18px', accentColor: 'var(--mint-600)', margin: '0', flex: 'none' }} />Click</label>
        ...
        <label className="quiz-option" data-option="q3-c" style={{ display: 'flex', alignItems: 'center', gap: '12px', padding: '14px 16px', borderRadius: 'var(--radius-md)', border: '1px solid var(--line)', background: 'rgba(255,255,255,.35)', cursor: 'pointer', fontSize: 'var(--text-base)', minHeight: '44px', boxSizing: 'border-box' }} style-hover="background:var(--glass)"><input type="radio" name="quiz-q3" id="quiz-q3-c" style={{ width: '18px', height: '18px', accentColor: 'var(--mint-600)', margin: '0', flex: 'none' }} />Uzum Bank</label>
        <label className="quiz-option" data-option="q3-d" style={{ display: 'flex', alignItems: 'center', gap: '12px', padding: '14px 16px', borderRadius: 'var(--radius-md)', border: '1px solid var(--line)', background: 'rgba(255,255,255,.35)', cursor: 'pointer', fontSize: 'var(--text-base)', minHeight: '44px', boxSizing: 'border-box' }} style-hover="background:var(--glass)"><input type="radio" name="quiz-q3" id="quiz-q3-d" style={{ width: '18px', height: '18px', accentColor: 'var(--mint-600)', margin: '0', flex: 'none' }} />Boshqa ilova</label>
        <label className="quiz-option" data-option="q3-e" style={{ display: 'flex', alignItems: 'center', gap: '12px', padding: '14px 16px', borderRadius: 'var(--radius-md)', border: '1px solid var(--line)', background: 'rgba(255,255,255,.35)', cursor: 'pointer', fontSize: 'var(--text-base)', minHeight: '44px', boxSizing: 'border-box' }} style-hover="background:var(--glass)"><input type="radio" name="quiz-q3" id="quiz-q3-e" style={{ width: '18px', height: '18px', accentColor: 'var(--mint-600)', margin: '0', flex: 'none' }} />Foydalanmadim</label>
      </div>
    </fieldset>
    <div className="quiz-actions" style={{ display: 'flex', justifyContent: 'space-between', gap: '12px' }}>
      <button type="button" id="btn-quiz-back" className="btn btn-ghost" style={{ fontFamily: 'var(--font-body)', fontWeight: '600', fontSize: 'var(--text-base)', padding: '12px 20px', borderRadius: 'var(--radius-md)', border: '1px solid transparent', background: 'transparent', color: 'var(--ink-mid)', cursor: 'pointer', minHeight: '44px', transition: 'background .12s' }} style-hover="background:var(--glass);color:var(--ink)">Orqaga</button>
      <button type="button" id="btn-quiz-next" className="btn btn-primary" style={{ fontFamily: 'var(--font-body)', fontWeight: '600', fontSize: 'var(--text-base)', padding: '12px 28px', borderRadius: 'var(--radius-md)', border: '1px solid rgba(255,255,255,.6)', background: 'linear-gradient(180deg,var(--mint-500),var(--mint-600))', color: '#fff', cursor: 'pointer', minHeight: '44px', boxShadow: 'var(--glow-mint),inset 0 1px 0 rgba(255,255,255,.35)', transition: 'filter .12s' }} style-hover="filter:brightness(1.08)">Keyingi</button>
    </div>
  </section>
</main>
    </>
